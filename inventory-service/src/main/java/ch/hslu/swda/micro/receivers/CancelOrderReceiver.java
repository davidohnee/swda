 ...
 * Returns: OrderInfo[]
 */
public final class CancelOrderReceiver implements MessageReceiver {
    ...
    public CancelOrderReceiver(final String exchangeName, final BusConnector bus, Inventory inventory) {
    ...
    public void onMessageReceived(final String route, final String replyTo, final String corrId, final String message) {
        ...
        try {
            ...
            String data = bus.talkSync(exchangeName, MessageRoutes.REPLENISHMENT_CANCEL, message);
