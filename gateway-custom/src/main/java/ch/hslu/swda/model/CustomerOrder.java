...
import ch.hslu.swda.model.Employee;
import ch.hslu.swda.model.OrderItem;
...
public class CustomerOrder {
    ...
    public CustomerOrder(UUID id, OffsetDateTime dateTime, StatusEnum status, List<@Valid OrderItem> orderItems, BigDecimal price, OrderTypeEnum orderType, Customer customer, Employee seller) {
        this.id = id;
    ...
    public CustomerOrder orderType(OrderTypeEnum orderType) {
        this.orderType = orderType;
        return this;
    }
