...
public class Shipment {
    ...
    private transient ch.hslu.swda.common.entities.Order customerOrder;
    ...
    public Shipment(UUID id, ch.hslu.swda.common.entities.Order customerOrder) {
        this.id = id;
    ...
    public Shipment customerOrder(ch.hslu.swda.common.entities.Order customerOrder) {
        this.customerOrder = customerOrder;
        return this;
    }
    ...
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
    public ch.hslu.swda.common.entities.Order getCustomerOrder() {
        return customerOrder;
    }
