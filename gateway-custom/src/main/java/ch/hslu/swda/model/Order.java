...
@JsonSubTypes({
  @JsonSubTypes.Type(value = CustomerOrder.class, name = "customerOrder"),
  @JsonSubTypes.Type(value = ReplenishmentOrder.class, name = "replenishmentOrder"),
})
