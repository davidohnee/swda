...
public class DataInitializer {
    ...
    private void initializeCustomers() {
        List<Customer> predefinedCustomers = List.of(
                new Customer(UUID.fromString("3759e709-c40c-4592-a978-35c6a6b338b2"), "Mick", "King", new Address("Muster Strasse", "20a", "6014", "Luzern"), new ContactInfo("mail.me@gmail.com", "+41 76 123 45 67"), new ObjectId()),
                new Customer(UUID.fromString("0a8a30d1-ecac-4e03-9419-b04158bc7178"), "Jack", "Daniel", new Address("Zentral Strasse", "13c", "6004", "Luzern"), new ContactInfo("jack.daniel@tennessee.us", "+1 122 122 12 12") , new ObjectId()),
                new Customer(UUID.fromString("d96933e4-9fcd-45f4-b3ac-e99e26ab3789"), "Chris", "Mastree", new Address("Zuger Strasse", "111", "6601", "Zug"), new ContactInfo("chris.mastree@santa.com", "+41 56 123 12 34") , new ObjectId()),
                new Customer(UUID.fromString("b5e798d9-fcc6-4200-8073-58ae0895acd4"), "Lea", "Fischer", new Address("Zellweg", "12p", "6014", "Luzern"), new ContactInfo("lea.fischer@bluewin.ch", "+41 79 678 87 45") , new ObjectId())
        );

        for (Customer customer : predefinedCustomers) {
            Customer existingCustomer = customerDAO.findByUUID(customer.getCustomerId());
